...
- **Artifacts / files** - Outputs (artifacts, created/presented files) are noted with a `_[Artifact: name]_` marker where they occurred, but their content is not embedded
